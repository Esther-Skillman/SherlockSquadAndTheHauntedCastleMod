...
local move =  {"4", "south","2","east","4","north","2","west"} --test case basic move ghost move reset when reach the start floor at the start of the new phase
...
local move4 = moves --test case get the move array from the level itself

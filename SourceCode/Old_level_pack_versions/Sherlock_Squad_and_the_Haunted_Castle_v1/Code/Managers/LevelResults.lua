...
local GhostsDied = game.saveData.getNumber('GhostsDied')
local GhostsCured = game.saveData.getNumber('GhostsReleased')
local totalGhosts = GhostsDied + GhostsCured



-- Display some text in the UI letting players know their 'score' (number of patients cured)
game.bus.send({
	displayText = 'You helped\n' .. GhostsCured .. ' out of ' .. totalGhosts .. '\nGhosts!\n\nMove your characters to choose what to do next.',

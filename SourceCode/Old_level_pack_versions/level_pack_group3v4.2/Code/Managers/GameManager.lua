...
--game.bus.send({ metadata = { 'playSound' }, data = { soundName = 'BackgroundMusic' } }, false)
--game.bus.send({ metadata = { 'playMusic' }, data = { soundName = 'Walk' } }, false)
--game.bus.send({ metadata = { 'music' }, data = { soundName = 'BackgroundMusic' } }, false)
--game.bus.send({ metadata = { 'sounds' }, data = { soundName = 'Walk' } }, false)
game.bus.send({ metadata = { 'playMusic' }, data = { soundName = '098_1' } }, false)
